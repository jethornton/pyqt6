...
from PyQt6.QtWidgets import QApplication, QFileDialog, QMainWindow, QMessageBox, QTextEdit
...
class MainWindow(QMainWindow):
	...
	def createActions(self):
		self.newAct = QAction("&New", self, shortcut=QKeySequence.StandardKey.New,
				statusTip="Create a new file", triggered=self.newFile)

		self.openAct = QAction("&Open...", self, shortcut=QKeySequence.StandardKey.Open,
				statusTip="Open an existing file", triggered=self.open)

		self.saveAct = QAction("&Save", self, shortcut=QKeySequence.StandardKey.Save,
