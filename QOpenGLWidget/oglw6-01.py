...
class mainWindow(QMainWindow):	#Main class.
	...
	def mousePressEvent(self, event):
		'''
		dir(event)
		'accept', 'allPointsAccepted', 'button', 'buttons', 'clone', 'device', 'deviceType',
		'exclusivePointGrabber', 'flags', 	'globalPosition', 'ignore', 'isAccepted', 'isBeginEvent',
		'isEndEvent', 'isInputEvent', 'isPointerEvent', 'isSinglePointEvent', 'isUpdateEvent',
		'modifiers', 'point', 'pointById', 'pointCount', 'pointerType', 'pointingDevice',
		'points', 'pos', 'position', 'registerEventType', 'scenePosition', 'setAccepted',
	...
	def mouseMoveEvent(self, event):
		'''
		print(dir(event))
		'accept', 'allPointsAccepted', 'button', 'buttons', 'clone', 'device', 'deviceType', 'exclusivePointGrabber', 'flags', 'globalPosition', 'ignore', 'isAccepted', 'isBeginEvent', 'isEndEvent', 'isInputEvent', 'isPointerEvent', 'isSinglePointEvent', 'isUpdateEvent', 'modifiers', 'point', 'pointById', 'pointCount', 'pointerType', 'pointingDevice', 'points', 'pos', 'position', 'registerEventType', 'scenePosition', 'setAccepted', 'setExclusivePointGrabber', 'spontaneous', 'timestamp', 'type'
		'''
		#print(event.pos().x())
